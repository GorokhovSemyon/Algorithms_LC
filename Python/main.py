...
class RandomizedSet:
    ...
    def insert(self, val: int) -> bool:
        ...
        # Добавляем элемент в словарь, где ключ - элемент, значение - индекс в списке
...
def integer_break(n: int) -> int:
    """
        ...
        :return: наибольшее произведение [int]
    """
    if n == 2:
        return 1
    if n == 3:
...
def full_bloom_flowers(flowers, people) -> list:
    """
        ...
        :param flowers: список списков, отображающий цветение цветка [List[List[int]]]
        :param people: список времён, в которые пришли люди [List[int]]
        :return:
    """
...
def num_factored_binary_trees(arr):
    """
        ...
        :return: количество возможных поддеревьев [int]
    """
    arr.sort()
...
def kth_grammar(n, k):
    """
        ...
        LC779
        :param n: номер уровня [int]
        :param k: номер позиции [int]
        :return:
    """
...
def cnt_vowel_permutation(n: int) -> int:
    """
        ...
        :return: количество комбинаций [int]
    """
    MOD = 10 ** 9 + 7
...
def largest_odd_number(num) -> str:
    """
        ...
        :return: строка с наибольшим числом, либо пустая строка [str]
    """
